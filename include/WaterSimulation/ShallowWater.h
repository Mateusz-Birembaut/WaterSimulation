...
public:
    ...
    ShallowWater(size_t nx_, size_t ny_, float dx_, float dt_, int groups = 16){
    ...
    void loadTerrainHeightMap(Magnum::Trade::ImageData2D* tex, float scaling = 1.0f);
